...
__ANYTHING YOU WILL FIND IN THIS PAGE IS COMPLETELY UNOFFICIAL AND IT'S JUST THE RESULT OF AN EMPIRICAL TRIAL AND ERROR PROCEDURE.__
...
- __bottom layer exposure time__: if the test piece does not stick to the SBP, the time should be raised; if the test piece stick soo hard that the _auto-detach_ tool is not able to remove it, the time should be lowered.
...
However, one must consider that it will probably need some (i.e. tens) of tests to make a new profile. In particular, pay attention to these things:
- the pieces should be able to stick to the SBP
